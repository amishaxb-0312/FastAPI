...
class Patient(BaseModel):
    ...
    city:Annotated[str,Field(...,description='city in which patient live')]
...
@app.get('/sort')
def sort_patients(sort_by:str=Query(...,description='sort on the basis of height,wieght,bmi'),order:str=Query('asc',description='sort in asc or desc')):
